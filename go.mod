...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20260503210945-68f364621b3b
	...
	go.elastic.co/apm/module/apmgorilla/v2 v2.7.10
	go.elastic.co/apm/module/apmgrpc/v2 v2.7.10
	go.elastic.co/apm/v2 v2.7.10
...
require (
	...
	go.elastic.co/apm/module/apmhttp/v2 v2.7.10 // indirect
